...
<body>
    ...
    <%
        ...
        Map<String, Object> queryResult = db.SelectQuery("vuumpet_rental", "");
            ...
            <tbody>
                ...
                %>
                    <tr>
                        ...
                        <td><%= rental[3] %></td> 
                        <td><%= rental[4] %></td> 
                        <td><button class="btn btn-danger"  onclick="delrental('<%=rental[2] %>')">삭제</button></td>
                    </tr>
                <%
                    }
                %>
