    ...
    <%
	    ...
	    if (success) {	
	    	...
	    	for (String[] product : prodcutInfo) {
	    		...
	    		String product_thumbnail = product[2];
	    		String product_price =  product[3];
	    		String product_info =  product[4];
	    		String product_details = product[5];
	    		String product_stock  = product[6];
	    		String category_id  = product[7];		
	%>
	                    ...
	                    %>
	                            <%
	                                for (String[] category : results) {
	                                	String currentCategoryId = category[0]; // 카테고리 ID
	                                    String categoryName = category[1];      // 카테고리 이름
	                                    // category_id와 현재 카테고리 ID가 일치하면 selected 추가
